...
namespace CnoomFrameWork.Base.Container
{
    ...
    {
        protected Dictionary<string,ChildContainer> ChildContainers = new Dictionary<string,ChildContainer>();
        ...
        {
            if(ChildContainers.TryGetValue(name, out ChildContainer childContainer))
            {
